      ...
      <header style={{ background: "linear-gradient(135deg, #0a0e18 0%, #0f224e 40%, #3e5184 100%)", padding: "56px 32px 0", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <div style={{
            ...
            background: "#e8ecf0", color: "#0f224e",
            borderRadius: "12px 12px 0 0", fontSize: "0.9rem", fontWeight: 700,
            fontFamily: "var(--f-display)", textTransform: "uppercase", letterSpacing: "0.04em",
          }}>The Big Picture</div>
        </div>
      </header>
